...
struct EntrySheet: View {
    ...
    @State private var tag: String = PanicLogTags.all.first ?? ""
    ...
    var body: some View {
        NavigationStack {
            Form {
                ...
                Section("Coping method") {
                    Picker("Coping method", selection: $tag) {
                        ForEach(PanicLogTags.all, id: \.self) { t in
                            Text(t).tag(t)
                        }
                    }
                    .pickerStyle(.menu)
