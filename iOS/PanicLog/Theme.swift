...
/// Panic Log's identity: a palette built specifically for this app's domain
/// (episode tracking) - not a shared portfolio default.
enum AppTheme {
    static let backdrop = Color(red: 0.949, green: 0.941, blue: 0.965)
    static let card = Color.white
    static let cardBorder = Color(red: 0.396, green: 0.31, blue: 0.588).opacity(0.18)

    static let ink = Color(red: 0.12, green: 0.12, blue: 0.14)
    static let inkFaded = Color(red: 0.12, green: 0.12, blue: 0.14).opacity(0.56)

    static let accent = Color(red: 0.396, green: 0.31, blue: 0.588)
    static let accentDeep = Color(red: 0.271, green: 0.204, blue: 0.427)
